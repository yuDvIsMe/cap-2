			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped table-hover">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT v.*,t.law_name,t.type from `violations` v join `traffic_law` t on v.law_id = t.id order by unix_timestamp(date_created) desc ");
						...
						?>
							<tr class="text-center" title="<?php echo $row['description'] ?>">
								...
								<td><?php echo ($row['type'] == 1) ? "Xe máy":"Ô tô" ?></td>
								<td>
									<p class="truncate m-0 text-danger"><b><?php echo $row['law_name'] ?></b></p>
								</td>
								<td>
