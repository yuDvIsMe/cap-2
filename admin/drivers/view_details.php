...
<div class="container-fluid">
    <div class="w-100 d-flex justify-content-end mb-2">
        <button class="btn btn-flat btn-sm btn-default bg-lightblue" type="button" id="print"><i class="fa fa-print"></i> In thông tin</button>
    ...
    <div class="border border-dark px-2 py-2" id="print_out">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Số GPLX:</label>
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $license_id_no ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Loại GPLX:</label>
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $license_type ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Họ và tên:</label>
                            ...
                            <div class="row justify-content-between  w-max-100">
                                ...
                                <div class="col-6 d-flex w-max-100">
                                    <label class="float-left w-auto whitespace-nowrap">Số điện thoại: </label>
                                    <p class="col-md-auto border-bottom px-2 border-dark w-100"><b><?php echo $contact ?></b></p>
                                </div>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Quốc tịch:</label>
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $nationality ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Địa chỉ thường trú:</label>
        ...
        <h4 class="text-center"><b>Lịch sử vi phạm</b></h4>
        <table class='table table-stripped px-4'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo ($row['status'] == 1) ? "Đã thanh toán" : 'Chưa thanh toán' ?></td>
                </tr>
                <?php endwhile; ?>
                <?php if($olist->num_rows <= 0): ?>
                <tr>
                    <th class="text-center" colspan="4">Thông tin trống</th>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
