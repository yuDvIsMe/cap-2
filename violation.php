...
<div class="container-fluid">
    ...
    <div class="border border-dark px-2 py-2" style="overflow: hidden;" id="print_out">
        ...
        <div class="w-100 d-flex justify-content-end mb-2">
            <a href="<?php echo base_url ?>?page=payment" class="btn btn-primary btn-lg active mr-2" role="button" aria-pressed="true" style="font-size: 0.9rem;">Thanh toán trực tuyến với VNPAY</a>
